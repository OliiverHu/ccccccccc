    ...
    def __getitem__(self, idx):
        ...
        for train_instance in self.instances[l_bound:r_bound]:
            ...
            for obj in all_objs:
                ...
                center_x = obj['point0'][0]
                center_x = center_x / float(net_w) * grid_w # sigma(t_x) + c_x
                center_y = obj['point0'][1]
                center_y = center_y / float(net_h) * grid_h # sigma(t_y) + c_y
                
                # determine the sizes of the bounding box
                w = np.log((obj['whl'][0]) / float(max_anchor.xmax)) # t_w
                h = np.log((obj['whl'][1]) / float(max_anchor.ymax)) # t_h
                ...
                yolo[instance_count, grid_y, grid_x, max_index%3, 0  ] = 1.
                yolo[instance_count, grid_y, grid_x, max_index%3, 1:5] = box
                yolo[instance_count, grid_y, grid_x, max_index%3, 5:7] = [1.*obj['inf'], 1.*obj['sup']]
                yolo[instance_count, grid_y, grid_x, max_index%3, 7+obj_indx] = 1.

                # assign the true box to t_batch
                true_box = [center_x, center_y, obj['whl'][0], obj['whl'][1]]
